...
import it.italiandudes.despicable_cards.javafx.controllers.ControllerScenePromptJoin;
...
public final class ScenePromptJoin {
    ...
    private static SceneController genScene() {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.FXML_PROMPT_JOIN));
            Parent root = loader.load();
            ControllerScenePromptJoin controller = loader.getController();
