...
import it.italiandudes.despicable_cards.javafx.controllers.game.ControllerSceneGameMaster;
...
public final class SceneGameMaster {

    // Scene Generator
    @NotNull
    public static SceneController getScene(
            @NotNull final PlayerData playerData, @NotNull final BlackCard blackCard,
            @NotNull final PlayerDataManager playersDataManager, @NotNull Socket connectionToServer) {
        return Objects.requireNonNull(genScene(playerData, blackCard, playersDataManager, connectionToServer));
    }
    @Nullable
    private static SceneController genScene(
            ...
            @NotNull final PlayerDataManager playersDataManager, @NotNull Socket connectionToServer) {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.Game.FXML_MASTER));
            Parent root = loader.load();
            ControllerSceneGameMaster controller = loader.getController();
